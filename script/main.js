...
const animationTimeline = () => {
  ...
  // Ensure spaces are not removed by using a regex to split words and spaces separately
  ...
  console.log(textBoxChars.innerHTML); // Debugging
  console.log(hbd.innerHTML); // Debugging
  ...
  tl.to(".container", 0.1, {
    ...
    .to(".fake-btn", 0.1, { backgroundColor: "#ff69b4" }) // Cute pink
    ...
    .to(".idea-3 strong", 0.5, { scale: 1.2, x: 10, backgroundColor: "#ff69b4", color: "#fff" }) // Cute pink
    ...
    .staggerFromTo(".wish-hbd span", 0.7, { scale: 1.4, rotationY: 150 }, { scale: 1, rotationY: 0, color: "#ff69b4", ease: Expo.easeOut }, 0.1, "party") // Cute pink
